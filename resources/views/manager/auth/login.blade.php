  ...
  <body>
    <div class="v91_127">
      ...
      <div class="v91_139">
        ...
        <div class="v91_143">
          <span class="v91_144">Manager Login</span>
        ...
        <form action="{{ route('relationship-manager.login') }}" method="post">
          @csrf
          <div class="v91_158">
            <label for="email">
        ...
        <div class="v91_146">
          ...
          <span class="v91_148">
            ...
            <a href="{{ route('relationship-manager.registration') }}">Create a Manager Account</a>
          </span>
        </div>
      </div>
    </div>
